...
function typeWriterLabels(containerId, speed = 10) {
    ...
    // Hide everything and store clean text (with newlines instead of <br>)
    labels.forEach(label => {
        ...
        label.textContent = "";              // clear visual text
        label.style.visibility = "hidden";   // hide label until we start typing it
